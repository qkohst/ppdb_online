...
<body>
  ...
  <header id="header" class="fixed-top">
    ...
    <div class="container">
        ...
        <div class="col-lg-6" data-aos="zoom-in">
            <img src="assets/img/brosur_ppdb.jfif" class="img-fluid" alt="">
        </div>
  ...
  <footer id="footer">
        ...
        <div class="row">
          <div class="col-lg-8 col-md-6">
            <div class="footer-info">
              <h3>SMP Darut Tauhid Tambakboyo</h3>
              <p>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>2020</span></strong>. SMP Darut Tauhid Tambakboyo
      </div>
      <div class="credits">
        ...
        Developed by <a href="https://bootstrapmade.com/">Qkoh St.</a>
      </div>
    </div>
  </footer><!-- End Footer -->
